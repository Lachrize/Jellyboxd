...
export function LogoMark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Translate to center the 200x214 jellyfish in a 200x200 viewBox */}
...
/** Large jellyfish mascot for setup/login pages. */
export function LogoMarkLarge({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 200 200"
    ...
    >
      <defs>
        <linearGradient id="jb-bell-lg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#B354D9" />
          <stop offset="0.55" stopColor="#5C6FE0" />
          <stop offset="1" stopColor="#00A4DC" />
        </linearGradient>
        <linearGradient id="jb-bell-inner-lg" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#ffffff" stopOpacity="0.45" />
          <stop offset="1" stopColor="#ffffff" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="jb-tent-lg" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#6A4ECB" />
          <stop offset="1" stopColor="#2C6FD8" />
        </linearGradient>
      </defs>
      <g transform="translate(0, -7)">
        <g fill="none" stroke="url(#jb-tent-lg)" strokeWidth="6" strokeLinecap="round">
          <path d="M66,118 C60,136 72,148 64,166 C58,180 60,192 56,204" />
          <path d="M83,122 C79,142 91,154 85,174 C81,190 82,198 80,208" />
          <path d="M100,124 C98,144 106,158 100,178 C96,194 99,202 100,210" />
          <path d="M117,122 C121,142 109,154 115,174 C119,190 118,198 120,208" />
